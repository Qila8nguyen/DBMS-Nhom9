...
class Model_Login extends Database
{
    ...
    {
        $sql = "SELECT DISTINCT tentaikhoan, hoten FROM quantrivien WHERE tentaikhoan = :username 
        UNION 
        SELECT DISTINCT username, name FROM students WHERE username = :username";
    ...
    {
        $sql = "SELECT DISTINCT permission,matkhau FROM quantrivien WHERE tentaikhoan = :username
        UNION
        SELECT DISTINCT permission,password FROM students WHERE username = :username ";
